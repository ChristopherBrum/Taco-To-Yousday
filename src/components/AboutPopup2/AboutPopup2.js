...
function AboutPopup2(props) {
  return(
    <div className='about2-popup'>  
      <div className='about2-popup-inner'>  
        <div>
          ...
          <p className="about2-body-subtitle">Getting started is easy:</p>
            <ol>
            ...
            <p className="about2-body">Then, kick back and wait for Taco Tuesday to come to you</p>        
        </div>
